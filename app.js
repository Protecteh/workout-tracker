(() => {
  ...
  const DEFAULT_EXERCISE_AREAS = {
    ...
    "default-incline-dumbbell-press": "upper-chest",
    "default-low-to-high-cable-fly": "upper-chest",
    "default-dips": "lower-chest",
    "default-decline-pushups": "lower-chest",
    ...
    "default-back-extension": "lower-back",
    "default-good-morning": "lower-back",
    "default-face-pull": "upper-back",
    "default-reverse-fly": "upper-back",
    "default-chest-supported-row": "upper-back",
    ...
    "default-reverse-pec-deck": "rear-delts",
    "default-bent-over-rear-delt-raise": "rear-delts",
    ...
    "default-barbell-shrugs": "traps",
    "default-farmer-carry": "traps",
    ...
    "default-reverse-curls": "brachialis-forearms",
    "default-wrist-curls": "brachialis-forearms",
    ...
    "default-seated-calf-raise": "calves",
    "default-single-leg-calf-raise": "calves",
    ...
    "default-reverse-crunch": "lower-abs",
    "default-flutter-kicks": "lower-abs",
    "default-crunches": "abs",
    "default-sit-ups": "abs",
    "default-russian-twists": "obliques",
    "default-side-plank": "obliques",
    ...
    "default-treadmill-intervals": "intervals"
  };
  ...
  const DEFAULT_EXERCISES = [
    ...
    { id: "default-incline-dumbbell-press", name: "Incline dumbbell press", muscleGroup: "Chest", type: "strength" },
    { id: "default-low-to-high-cable-fly", name: "Low-to-high cable fly", muscleGroup: "Chest", type: "strength" },
    { id: "default-dips", name: "Dips", muscleGroup: "Chest", type: "bodyweight" },
    { id: "default-decline-pushups", name: "Decline pushups", muscleGroup: "Chest", type: "bodyweight" },
    ...
    { id: "default-back-extension", name: "Back extension", muscleGroup: "Back", type: "bodyweight" },
    { id: "default-good-morning", name: "Good morning", muscleGroup: "Back", type: "strength" },
    { id: "default-face-pull", name: "Face pull", muscleGroup: "Back", type: "strength" },
    { id: "default-reverse-fly", name: "Reverse fly", muscleGroup: "Back", type: "strength" },
    { id: "default-chest-supported-row", name: "Chest-supported row", muscleGroup: "Back", type: "strength" },
    ...
    { id: "default-reverse-pec-deck", name: "Reverse pec deck", muscleGroup: "Shoulders", type: "strength" },
    { id: "default-bent-over-rear-delt-raise", name: "Bent-over rear delt raise", muscleGroup: "Shoulders", type: "strength" },
    ...
    { id: "default-barbell-shrugs", name: "Barbell shrugs", muscleGroup: "Shoulders", type: "strength" },
    { id: "default-farmer-carry", name: "Farmer carry", muscleGroup: "Shoulders", type: "strength" },
    ...
    { id: "default-reverse-curls", name: "Reverse curls", muscleGroup: "Arms", type: "strength" },
    { id: "default-wrist-curls", name: "Wrist curls", muscleGroup: "Arms", type: "strength" },
    ...
    { id: "default-seated-calf-raise", name: "Seated calf raise", muscleGroup: "Legs", type: "strength" },
    { id: "default-single-leg-calf-raise", name: "Single-leg calf raise", muscleGroup: "Legs", type: "bodyweight" },
    ...
    { id: "default-reverse-crunch", name: "Reverse crunch", muscleGroup: "Core", type: "bodyweight" },
    { id: "default-flutter-kicks", name: "Flutter kicks", muscleGroup: "Core", type: "bodyweight" },
    ...
    { id: "default-side-plank", name: "Side plank", muscleGroup: "Core", type: "bodyweight" },
    ...
    { id: "default-treadmill-intervals", name: "Treadmill intervals", muscleGroup: "Cardio", type: "cardio" }
  ].map((exercise) => ({
    ...exercise,
